...
if __name__ == "__main__":
    ...
    logging.warning(
        "This is a Markov Chain Montecarlo simulator of a supermarket over a single working day (7:00-22:00).\nThe simulation will start in a few seconds...\n"
    )
